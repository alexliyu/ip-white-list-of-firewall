...
class sys_plugin(Plugin):
	def __init__(self):
		...
		self.author="CDM"
		self.authoruri="http://ccdm.tk"
		self.uri="http://ccdm.tk"
		self.description="System plugin for cdm"
	...
	def head(self,content,blog=None,*arg1,**arg2):
		content=content+'<meta name="generator" content="cdm %s" />'%blog.version
		return content

	def footer(self,content,blog=None,*arg1,**arg2):

		return content+'<!--Powered by cdm %s-->'%blog.version
	...
	def get(self,page):
		return '''<h3>Sys Plugin</h3>
			   <p>This is a system plugin for cdm. <br>Also a demo for how to write plugin for cdm.</p>
			   <h4>feature</h4>
			   <p><ol>
			   <li>Add Meta &lt;meta name="generator" content="cdm x.x" /&gt;</li>
			   <li>Add footer "&lt;!--Powered by cdm x.x--&gt;"</li>
