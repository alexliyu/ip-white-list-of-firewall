			...
			<body>
				...
				<div id="intro">
					<p>
						...
						It was generated using the Blogging-Software <a href="http://ccdm.tk">cdm</a> .<br />
				...
				<div id="footer">
					Generated with <a href="http://ccdm.tk/cdm" title="CDM SYSTEM powered by google app engine">cdm</a> by <a href="http://ccdm.tk">ccdm.tk</a>. This XSLT template is released under GPL.
				</div>
			</body>
		</html>
	</xsl:template>
