...
*/
	...
	*/
		function buildPanels() {
			...
			if(!opts.show_filmstrip) {
				$('<img />').addClass('nav-next').attr('src','/static/images/next.gif').appendTo(j_gallery).css({
					'position':'absolute',
					'zIndex':'1100',
					'cursor':'pointer',
				...
				$('<img />').addClass('nav-prev').attr('src','/static/images/prev.gif').appendTo(j_gallery).css({
					'position':'absolute',
					'zIndex':'1100',
					'cursor':'pointer',
					'top':((opts.panel_height-22)/2)+gallery_padding+'px',
				...
				$('<img />').addClass('nav-next-overlay').attr('src','/static/images/panel-nav-next.gif').appendTo(j_gallery).css({
					'position':'absolute',
					'zIndex':'1099',
				...
				$('<img />').addClass('nav-prev-overlay').attr('src','/static/images/panel-nav-prev.gif').appendTo(j_gallery).css({
					'position':'absolute',
					'zIndex':'1099',
					'top':((opts.panel_height-22)/2)+gallery_padding-10+'px',
					'left':'0',
	...
	*/
		function buildFilmstrip() {
			...
			var navNext = $('<img />');
			navNext.addClass('nav-next').attr('src','/static/images/next.gif').appendTo(j_gallery).css({
				'position':'absolute',
				'cursor':'pointer'
			}).click(showNextItem);
			var navPrev = $('<img />');
			navPrev.addClass('nav-prev').attr('src','/static/images/prev.gif').appendTo(j_gallery).css({
				'position':'absolute',
				'cursor':'pointer'
			}).click(showPrevItem);
			if(filmstrip_orientation=='horizontal') {
